...
| เมื่อหมดเวลา จะเป็นการคิดคะแนน โดยพิจารณาตามจำนวน objectives ที่ทำสำเร็จ (75%) และคะแนนโหวตจากผู้ชมในงาน (25%) | Once the time is up, the editor will be locked, and then each submission will be scored based on the number of objectives (75%) met and audience votes (25%). |