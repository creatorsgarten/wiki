...
- Each talk goes through several stages before they are published to the YouTube channel.
   ...
   2. **Timestamp** — Determine the time range within the source material that contains the talk. It does not need to be precise, just a hint for other teammates on where to find the talk.
