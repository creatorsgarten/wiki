...
<a href="{{link.url}}" style="padding: 0.5rem; display: flex; text-align: center; border-radius: 0.25rem; background: {{ bg }}; color: #fff;"><span style="display: flex; align-items: center; flex: none"><iconify-icon icon="clarity:world-line"></iconify-icon></span><span style="flex: 1"><strong>{{link.title}}</strong></span></a>
{%- endfor %}
</div>
