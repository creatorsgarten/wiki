...
| --------- | ----------- | ----- | ----- |
| LG TV SSCR2 86-inch television | Video output | | Default picture mode is APS (Auto Power Save)<br>For best latency, when connecting, click ‘Show all resolutions’ and set ‘Refresh rate’ to ‘60 Hertz’ and set ‘Picture Mode’ to ‘Game’.<br>There is an audio delay of about 60 ms. |
